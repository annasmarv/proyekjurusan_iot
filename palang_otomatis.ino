...
// Ambang jarak untuk mendeteksi kendaraan (dalam cm)
...
void loop() {
  ...
  // Jika jarak lebih kecil dari ambang batas, buka palang pintu
  if (distance < thresholdDistance) {
    myServo.write(90); // Buka palang pintu (90 derajat)
    delay(4000); // Biarkan palang terbuka selama 5 detik
  } else {
    // Tutup palang pintu jika tidak ada kendaraan
    myServo.write(0); // Tutup palang pintu (0 derajat)
  }
